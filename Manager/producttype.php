...
if(isset($_POST['ctype'])   )
{
  ...
  $query="INSERT INTO ProductType (ProductType) VALUES ('$data1')";
  ...
  <nav class="navbar navbar-expand-lg navbar-light light-bg fixed-top">
    ...
    >
     ...
     <i class="fas fa-database"></i>
             ...
             <li>
              <a href="producttype.php" class="nav-link px-3 text-primary">
                <span class="me-2">
                 <i class="fas fa-database"></i>
                </span>
                ProductType
        ...
        <div class="row">
          <div class="col mx-3">
            <div class="row mb-2 pb-3">
              <div class="col-xs-8">
                <h2 class="h3 page-header">ProductType </h2>
              </div>
            </div>
            <hr class="dropdown-divider" />
            <div class="card rounded-0 mt-3">
              <div class="card-header p-2 mb-3">
                <h5 class="card-title font-weight-bold">All ProductType </h5>
              </div>
              <div class="card-body">
        ...
        <div class="modal-content rounded-0">
          <div class="modal-header py-0 border-0">
            ...
            >
              ...
              <span style="font-size: 35px">P</span>roductType
            </h3>
          </div>
    ...
    <div
      class="modal fade"
      id="editUserModal<?php echo $arr1['ProductTypeNo']; ?>"
      tabindex="-1"
          ...
          <div class="modal-body">
              ...
              <div class="form-group mb-3">
                ...
                <input
                  ...
                  type="text"
                  name="mtype"
                  value="<?php echo $arr1['ProductType']; ?>"
                  id="utype<?php echo $arr1['ProductTypeNo']; ?>"
                />
              </div>
              ...
              <div class="mt-4 text-center">
                ...
                <button type="submit"    id="Update<?php echo $arr1['ProductTypeNo']; ?>" class="btn btn-dark btn btn-sm rounded-0"  data-bs-dismiss="modal">
                  Update Data
                </button>
              </div>
    ...
    <div
      class="modal fade"
      id="deleteConfirmModal<?php echo $arr1['ProductTypeNo']; ?>"
      tabindex="-1"
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="mx-auto text-center">
              ...
              <button class="btn btn-danger"  id="Delete<?php echo $arr1['ProductTypeNo']; ?>" data-bs-dismiss="modal">Delete</button>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  Show();
  $("#Delete<?php echo $arr1['ProductTypeNo']; ?>").click(function() {
                var id=<?php echo $arr1['ProductTypeNo']; ?>;
               

            $.ajax({
                type: "POST",
                url: "deleteproducttype.php",
                data: {
  ...
  $("#Update<?php echo $arr1['ProductTypeNo']; ?>").click(function() {
                var id=<?php echo $arr1['ProductTypeNo']; ?>;
                var data1=$('#utype<?php echo $arr1['ProductTypeNo']; ?>').val();
