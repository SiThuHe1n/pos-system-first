              ...
              <a href="orderdata.php" class="nav-link px-3 ">
               ...
               <i class="fas fa-database"></i>
                ...
                Order
                  ...
                  <li>
              <a href="orderonlinedata.php" class="nav-link px-3 text-primary ">
                <span class="me-2">
               <i class="fas fa-database"></i>
                </span>
                Order(Online)
        ...
        <div class="row">
          <div class="col mx-3">
            <div class="row mb-2 pb-3">
              <div class="col-xs-8">
                <h2 class="h3 page-header">Order Online  </h2>
              </div>
            </div>
            <hr class="dropdown-divider" />
            <div class="card rounded-0 mt-3">
              <div class="card-header p-2 mb-3">
                <h5 class="card-title font-weight-bold">All Order at Online Data </h5>
              </div>
              <div class="card-body">
               ...
               <?php 
               $ppid=$_GET['ppid'];
$query="SELECT * FROM SaleOrder WHERE OrderStatus='OnlineOrder'";
$result=mysqli_query($Connect,$query);
$number=0;
