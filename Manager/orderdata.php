              ...
              <a href="Saledata.php" class="nav-link px-3 ">
               ...
               <i class="fas fa-database"></i>
                ...
                Sale
                  ...
                  <li>
              <a href="orderdata.php" class="nav-link px-3 text-primary ">
                <span class="me-2">
               <i class="fas fa-database"></i>
                </span>
                Order
        ...
        <div class="row">
          <div class="col mx-3">
            <div class="row mb-2 pb-3">
              <div class="col-xs-8">
                <h2 class="h3 page-header">Order  </h2>
              </div>
            </div>
            <hr class="dropdown-divider" />
            <div class="card rounded-0 mt-3">
              <div class="card-header p-2 mb-3">
                <h5 class="card-title font-weight-bold"> Order at Shop </h5>
              </div>
              <div class="card-body">
               ...
               <?php 
               $ppid=$_GET['ppid'];
$query="SELECT * FROM SaleOrder WHERE OrderStatus='orderatshop'";
$result=mysqli_query($Connect,$query);
$number=0;
                        ...
                        $res3=mysqli_query($Connect,$dat3);
                          if (mysqli_num_rows($res3) > 0) {
                            ...
                            $ShopName=$arr3['ShopName'];
                             ...
                             $dat3="SELECT * FROM Staff WHERE StaffID='$stafid' ";
                        $res3=mysqli_query($Connect,$dat3);
                          if (mysqli_num_rows($res3) > 0) {
                            $arr3 = mysqli_fetch_array($res3);
...
echo '   <tr>
                      <th scope="row">'.$arr1['SO_ID'].'</th>
                       ...
                       <td>'.$ShopName.'</td>
                          <td>'.$StaffName.'</td>
                             <td>'.$paymenttype.'</td>
   <td><a href="saledetail.php?soid='.$arr1['SO_ID'].'" class="btn btn-primary">View</a></td>
