...
if(isset($_POST['cproduct']) && isset($_POST['ctype'])  )
{

  $data1=$_POST['cproduct'];

  $data2=$_POST['ctype'];



  $query="INSERT INTO ProductDetail (ProductID,MeasurementTypeNo) VALUES ('$data1','$data2')";
...
<html lang="en">
  ...
  <body>
    ...
    >
     ...
     <i class="fas fa-database"></i>
       ...
       <i class="fas fa-database"></i>
               ...
               <li>
              <a href="productdetail.php" class="nav-link px-3 text-primary">
                <span class="me-2">
            <i class="fas fa-database"></i>
                </span>
                ProductDetail
          ...
          <div class="col mx-3">
            ...
            <div class="card rounded-0 mt-3">
              <div class="card-header p-2 mb-3">
                <h5 class="card-title font-weight-bold">All Product Details </h5>
              </div>
              <div class="card-body">
        ...
        <div class="modal-content rounded-0">
          <div class="modal-header py-0 border-0">
            ...
            >
              ...
              <span style="font-size: 35px">P</span>roductDetail
            </h3>
          </div>
          ...
          <div class="modal-body">
            <form  method="POST" action="productdetail.php">
                ...
                <label for="type">Name :</label>
                 <select class="form-control" name="cproduct" id="cproduct" required>
                  <?php $qrole="SELECT * FROM Product";
                        $roless=mysqli_query($Connect,$qrole);
                          if (mysqli_num_rows($roless) > 0) {
                       while($arr1 = mysqli_fetch_array($roless)){
                        echo "<option value='".$arr1['ProductID']."'>".$arr1['ProductName']."</option>
              ";
                       }
                     }
                ...
                <label for="type">Measurement :</label>
                 <select class="form-control" name="ctype" id="ctype" required>
                  <?php $qrole="SELECT * FROM Measurement";
                        $roless=mysqli_query($Connect,$qrole);
                          if (mysqli_num_rows($roless) > 0) {
                       while($arr1 = mysqli_fetch_array($roless)){
                        echo "<option value='".$arr1['MeasurementTypeNo']."'>".$arr1['MeasurementType']."</option>
              ";
                       }
                     }
    ...
    <div
      class="modal fade"
      id="editUserModal<?php echo $arr1['PD_ID']; ?>"
      tabindex="-1"
        ...
        <div class="modal-content rounded-0">
          ...
          <div class="modal-body">
              ...
              <div class="form-group mb-3">
                ...
                <select class="form-control" name="utype"    id="uproduct<?php echo $arr1['PD_ID']; ?>" required>
                          <?php $qrole="SELECT * FROM Product";
                        $roless=mysqli_query($Connect,$qrole);
                          if (mysqli_num_rows($roless) > 0) {
                       while($arr2 = mysqli_fetch_array($roless)){
                        ...
                        {
                               echo "<option value='".$arr2['ProductID']."' selected>".$arr2['ProductName']."</option>
              ";
                        }
                        else
                        {
                               echo "<option value='".$arr2['ProductID']."'>".$arr2['ProductName']."</option>
              ";
                        }
              ...
              <select class="form-control" name="utype"    id="utype<?php echo $arr1['PD_ID']; ?>" required>
                          <?php $qrole="SELECT * FROM Measurement";
                        $roless=mysqli_query($Connect,$qrole);
                          if (mysqli_num_rows($roless) > 0) {
                       while($arr2 = mysqli_fetch_array($roless)){
                        if($arr1['MeasurementTypeNo']==$arr2['MeasurementTypeNo'])
                        {
                               echo "<option value='".$arr2['MeasurementTypeNo']."' selected>".$arr2['MeasurementType']."</option>
              ";
                        }
                        else
                        {
                               echo "<option value='".$arr2['MeasurementTypeNo']."'>".$arr2['MeasurementType']."</option>
              ";
                        }
              ...
              <div class="mt-4 text-center">
                ...
                <button type="submit"    id="Update<?php echo $arr1['PD_ID']; ?>" class="btn btn-dark btn btn-sm rounded-0"  data-bs-dismiss="modal">
                  Update Data
                </button>
              </div>
    ...
    <div
      class="modal fade"
      id="deleteConfirmModal<?php echo $arr1['PD_ID']; ?>"
      tabindex="-1"
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="mx-auto text-center">
              ...
              <button class="btn btn-danger"  id="Delete<?php echo $arr1['PD_ID']; ?>" data-bs-dismiss="modal">Delete</button>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  Show();
  $("#Delete<?php echo $arr1['PD_ID']; ?>").click(function() {
                var id=<?php echo $arr1['PD_ID']; ?>;
               

            $.ajax({
                type: "POST",
                url: "deleteproductdetail.php",
                data: {
  ...
  $("#Update<?php echo $arr1['PD_ID']; ?>").click(function() {
                var id=<?php echo $arr1['PD_ID']; ?>;
                var data1=$('#uproduct<?php echo $arr1['PD_ID']; ?>').val();
                var data2=$('#utype<?php echo $arr1['PD_ID']; ?>').val();
