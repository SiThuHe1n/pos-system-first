...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light light-bg fixed-top">
       ...
       <i class="fas fa-database"></i>
            ...
            <i class="fas fa-database"></i>
              ...
              <a href="price.php" class="nav-link px-3 ">
               ...
               <li>
              <a href="inventory.php" class="nav-link px-3 text-primary ">
                <span class="me-2">
               <i class="fas fa-database"></i>
                </span>
                Inventory
        ...
        <div class="row">
          <div class="col mx-3">
            <div class="row mb-2 pb-3">
              <div class="col-xs-8">
                <h2 class="h3 page-header">Inventory </h2>
              </div>
            </div>
            <hr class="dropdown-divider" />
            <div class="card rounded-0 mt-3">
              <div class="card-header p-2 mb-3">
                <h5 class="card-title font-weight-bold">All Inventory </h5>
              </div>
              <div class="card-body">
        ...
        <div class="modal-content rounded-0">
          <div class="modal-header py-0 border-0">
            ...
            >
              ...
              <span style="font-size: 35px">I</span>nventory
            </h3>
          </div>
    ...
    <div
      class="modal fade"
      id="deleteConfirmModal<?php echo $arr1['InventoryID']; ?>"
      tabindex="-1"
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="mx-auto text-center">
              ...
              <button class="btn btn-danger"  id="Delete<?php echo $arr1['InventoryID']; ?>" data-bs-dismiss="modal">Delete</button>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  Show();
  $("#Delete<?php echo $arr1['InventoryID']; ?>").click(function() {
                var id=<?php echo $arr1['InventoryID']; ?>;
