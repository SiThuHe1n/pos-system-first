                        ...
                        $res2=mysqli_query($Connect,$dat2);
                          if (mysqli_num_rows($res2) > 0) {
                            ...
                            $measurement=$arr3['MeasurementType'];
                             ...
                             $dat3="SELECT * FROM PriceType WHERE PriceTypeNo='$id3' ";
                        $res3=mysqli_query($Connect,$dat3);
                          if (mysqli_num_rows($res3) > 0) {
                            $arr3 = mysqli_fetch_array($res3);
                            $pricetype=$arr3['PriceType'];
...
echo '   <tr>
                      ...
                      <td>
                        <button
                          ...
                          data-bs-target="#editUserModal'.$arr1['PriceID'].'"
                        >
                          Edit
                        </button>
                        <button
                          ...
                          data-bs-toggle="modal"
                          data-bs-target="#deleteConfirmModal'.$arr1['PriceID'].'"
                        >
                          Delete
                        </button>
