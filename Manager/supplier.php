...
if(isset($_POST['cname']) && isset($_POST['cphone']) && isset($_POST['cemail']) && isset($_POST['caddress'])   )
{
  ...
  $data2=$_POST['cphone'];
  $data3=$_POST['cemail'];
  $data4=$_POST['caddress'];


  $query="INSERT INTO Supplier (Sup_Name,Sup_Phone,Sup_Email,Sup_Address) VALUES ('$data1','$data2','$data3','$data4')";
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light light-bg fixed-top">
      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-light">
          <ul class="navbar-nav">
            ...
            <li>
              <a href="supplier.php" class="nav-link px-3 text-primary">
                <span class="me-2">
                <i class="fas fa-database"></i>
                </span>
                Supplier
        ...
        <div class="row">
          <div class="col mx-3">
            <div class="row mb-2 pb-3">
              <div class="col-xs-8">
                <h2 class="h3 page-header">Supplier Management</h2>
              </div>
            </div>
            <hr class="dropdown-divider" />
            <div class="card rounded-0 mt-3">
              <div class="card-header p-2 mb-3">
                <h5 class="card-title font-weight-bold">All Suppliers </h5>
              </div>
              <div class="card-body">
        ...
        <div class="modal-content rounded-0">
          <div class="modal-header py-0 border-0">
            ...
            >
              ...
              <span style="font-size: 35px">S</span>upplier
            </h3>
          </div>
          ...
          <div class="modal-body">
            <form  method="POST" action="supplier.php">
              <div class="form-group mb-3">
                <label for="username">Supplier's Name:</label>
                <input
                id="cname"
                  type="text"
                  name="cname"
              ...
              <div class="form-group mb-3">
                <label for="email">Supplier's Phone:</label>
                <input
                id="cphone"
                  type="phone"
                  name="cphone"
                ...
                <div class="form-group mb-3">
                <label for="email">Supplier's Address:</label>
                <input
                id="caddress"
                  type="text"
                  name="caddress"
    ...
    <div
      class="modal fade"
      id="editUserModal<?php echo $arr1['SupplierID']; ?>"
      tabindex="-1"
          ...
          <div class="modal-body">
              ...
              <div class="form-group mb-3">
                ...
                <input
                  ...
                  type="text"
                  name="fullname"
                  value="<?php echo $arr1['Sup_Name']; ?>"
                  id="uname<?php echo $arr1['SupplierID']; ?>"
                />
              </div>
                ...
                <input
                  ...
                  type="phone"
                  name="uphone"
                  value="<?php echo $arr1['Sup_Phone']; ?>"
                     id="uphone<?php echo $arr1['SupplierID']; ?>"
                />
              </div>
              ...
              <div class="form-group mb-3">
                ...
                <input
                  ...
                  type="email"
                  name="uemail"
                  value="<?php echo $arr1['Sup_Email']; ?>"
                     id="uemail<?php echo $arr1['SupplierID']; ?>"
                />
              </div>
              ...
              <div class="form-group mb-3">
                ...
                <input
                  ...
                  type="text"
                  name="uaddress"
                     id="uaddress<?php echo $arr1['SupplierID']; ?>"
                  value="<?php echo $arr1['Sup_Address']; ?>"
                />
              </div>
              ...
              <div class="mt-4 text-center">
                ...
                <button type="submit"    id="Update<?php echo $arr1['SupplierID']; ?>" class="btn btn-dark btn btn-sm rounded-0"  data-bs-dismiss="modal">
                  Update Data
                </button>
              </div>
    ...
    <div
      class="modal fade"
      id="deleteConfirmModal<?php echo $arr1['SupplierID']; ?>"
      tabindex="-1"
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="mx-auto text-center">
              ...
              <button class="btn btn-danger"  id="Delete<?php echo $arr1['SupplierID']; ?>" data-bs-dismiss="modal">Delete</button>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  Show();
  $("#Delete<?php echo $arr1['SupplierID']; ?>").click(function() {
                var id=<?php echo $arr1['SupplierID']; ?>;
  ...
  $("#Update<?php echo $arr1['SupplierID']; ?>").click(function() {
                var id=<?php echo $arr1['SupplierID']; ?>;
                var data1=$('#uname<?php echo $arr1['SupplierID']; ?>').val();
                var data2=$('#uphone<?php echo $arr1['SupplierID']; ?>').val();
                var data3=$('#uemail<?php echo $arr1['SupplierID']; ?>').val();
                var data4=$('#uaddress<?php echo $arr1['SupplierID']; ?>').val();
