...
if(isset($_POST['cname']) && isset($_POST['clocation']) && isset($_POST['cphone']) && isset($_POST['caddress'])   )
{

  $data1=$_POST['cname'];

  $data2=$_POST['clocation'];
  $data3=$_POST['cphone'];
  $data4=$_POST['caddress'];


  $query="INSERT INTO Shop (ShopName,Shop_Location,Shop_Phone,Shop_Address) VALUES ('$data1','$data2','$data3','$data4')";
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light light-bg fixed-top">
     ...
     <i class="fas fa-database"></i>
       ...
       <i class="fas fa-database"></i>
            ...
            <i class="fas fa-database"></i>
               ...
               <li>
              <a href="shop.php" class="nav-link px-3 text-primary">
                <span class="me-2">
               <i class="fas fa-database"></i>
                </span>
                Shop
        ...
        <div class="row">
          <div class="col mx-3">
            <div class="row mb-2 pb-3">
              <div class="col-xs-8">
                <h2 class="h3 page-header">Shop Management</h2>
              </div>
            </div>
            <hr class="dropdown-divider" />
            <div class="card rounded-0 mt-3">
              <div class="card-header p-2 mb-3">
                <h5 class="card-title font-weight-bold">All Shop </h5>
              </div>
              <div class="card-body">
        ...
        <div class="modal-content rounded-0">
          <div class="modal-header py-0 border-0">
            ...
            >
              ...
              <span style="font-size: 35px">S</span>hop
            </h3>
          </div>
          ...
          <div class="modal-body">
            <form  method="POST" action="shop.php">
              ...
              <div class="form-group mb-3">
                <label for="email">Shop Location:</label>
                <input
                id="cphone"
                  type="phone"
                  name="clocation"
    ...
    <div
      class="modal fade"
      id="editUserModal<?php echo $arr1['Shop_ID']; ?>"
      tabindex="-1"
          ...
          <div class="modal-body">
              ...
              <div class="form-group mb-3">
                ...
                <input
                  ...
                  type="text"
                  name="fullname"
                  value="<?php echo $arr1['ShopName']; ?>"
                  id="uname<?php echo $arr1['Shop_ID']; ?>"
                />
              </div>
                ...
                <input
                  ...
                  type="phone"
                  name="uphone"
                  value="<?php echo $arr1['Shop_Location']; ?>"
                     id="ulocation<?php echo $arr1['Shop_ID']; ?>"
                />
              </div>
              ...
              <div class="form-group mb-3">
                ...
                <input
                  ...
                  type="email"
                  name="uemail"
                  value="<?php echo $arr1['Shop_Phone']; ?>"
                     id="uphone<?php echo $arr1['Shop_ID']; ?>"
                />
              </div>
              ...
              <div class="form-group mb-3">
                ...
                <input
                  ...
                  type="text"
                  name="uaddress"
                     id="uaddress<?php echo $arr1['Shop_ID']; ?>"
                  value="<?php echo $arr1['Shop_Address']; ?>"
                />
              </div>
              ...
              <div class="mt-4 text-center">
                ...
                <button type="submit"    id="Update<?php echo $arr1['Shop_ID']; ?>" class="btn btn-dark btn btn-sm rounded-0"  data-bs-dismiss="modal">
                  Update Data
                </button>
              </div>
    ...
    <div
      class="modal fade"
      id="deleteConfirmModal<?php echo $arr1['Shop_ID']; ?>"
      tabindex="-1"
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="mx-auto text-center">
              ...
              <button class="btn btn-danger"  id="Delete<?php echo $arr1['Shop_ID']; ?>" data-bs-dismiss="modal">Delete</button>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  Show();
  $("#Delete<?php echo $arr1['Shop_ID']; ?>").click(function() {
                var id=<?php echo $arr1['Shop_ID']; ?>;
  ...
  $("#Update<?php echo $arr1['Shop_ID']; ?>").click(function() {
                var id=<?php echo $arr1['Shop_ID']; ?>;
                var data1=$('#uname<?php echo $arr1['Shop_ID']; ?>').val();
                var data2=$('#ulocation<?php echo $arr1['Shop_ID']; ?>').val();
                var data3=$('#uphone<?php echo $arr1['Shop_ID']; ?>').val();
                var data4=$('#uaddress<?php echo $arr1['Shop_ID']; ?>').val();
